...
// const Footer = () => {
//   return (
//     <div className="relative h-[460px]  max-container padding-container rounded-3xl mt-40 mb-10">
//       <div className="relative z-10">
//         <footer className="bg-white/60 rounded-3xl">
      ...
      <div className="relative z-10">
        <footer className="bg-white/60 rounded-3xl">
          <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center text-gray-800 w-full max-container">
              <p className="text-sm text-center md:text-left mb-4 md:mb-0">
                &copy; 2023 DIAS Kite School | All rights reserved
              </p>

              <p className="text-sm text-gray-20">
                Made with <span className="text-red-500">&#x2764;</span> by
                <a
                  href="https://www.facebook.com/mym.ilham"
